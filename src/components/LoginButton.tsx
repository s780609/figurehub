...
function isInAppBrowser(): boolean {
  ...
  return /FBAN|FBAV|Line|Instagram|Twitter|Weibo|MicroMessenger|KAKAOTALK/i.test(ua);
}
  ...
  if (inApp) {
    return (
      <div className="space-y-3">
        ...
        <p className="text-xs text-[var(--foreground)]/40 text-center leading-relaxed">
          或手動複製網址，貼到 Chrome / Safari 開啟
        </p>
      </div>
    );
  }
